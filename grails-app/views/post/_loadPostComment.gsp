<div class="commontCont">
	...
	<g:remoteLink controller="post" action="loadmorepost"
		params='[commentRef:"${divUpdate}",offset:"${offset }"]'
		after="afterLoad()" update="updatePostCommentWall${offset}"
		class="load_more" id="load_more">load comments</g:remoteLink>
	<div id="updatePostCommentWall${offset}"></div>
