...
<body onload="focusQueryInput();">
	...
	<div class="quote_post_details">
		...
		<div id="header">
			...
			<g:form url='[controller: "searchTechbook", action: "searchpost"]'
        ...
        &nbsp;
					...
					<g:if test="${!searchResult?.suggestedQuery}">
						...
						<ul>
							<li>Try a suggested query: <g:link
									controller="searchTechbook" action="searchpost"
				...
				<g:if test="${searchResult?.suggestedQuery}">
					<p>
						Did you mean
						<g:link controller="searchTechbook" action="searchpost"
						...
						<g:if test="${LuceneUtils.queryHasSpecialCharacters(params.q)}">
							...
							<li>Escape special characters like <strong>" - [ ]</strong>
								...
								<em>Or use the Searchable Plugin's <strong>escape</strong>
									option: <g:link controller="searchTechbook" action="searchpost"
				...
				<g:if test="${haveResults}">
					<div class="tiles">
						<g:each var="result" in="${searchResult.results}" status="index">
							<div class="tile">
								<g:if test="${result?.postPic}">
									<g:link controller="post" action="show" id="${result.id}">
										<img
											src="<g:createLink controller='post' action='renderPostImage' id='${result.id}'/>"
											class="userpic" />
									</g:link>
								</g:if>
								<br>
								...
								- posted by:
								<g:link controller='user' action="show" id="${result.user.id}">
									${result.user.username }
								</g:link>
								<span> ${result.subject}
								</span> <span> ${result.topic}
								</span>
								<postDate:dateFromNow date="${result.dateCreated}" />
							</div>
						</g:each>
					</div>
              ...
              <g:set var="totalPages"
								...
								<g:else>
									<g:paginate controller="searchTechbook" action="searchpost"
